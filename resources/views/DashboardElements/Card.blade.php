        ...
        <div class="card-body">
            <div class="media align-items-center">
                ...
                <div class="text-left media-body">
                    <p class="mb-2 text-white fs-18">اخبار جدید</p>
                    <span class="text-white fs-48 font-w600">86</span>
                </div>
                <span class="p-3 ml-3 rounded feature-icon">
...
<div class="col-xl-3 col-xxl-6 col-sm-6">
    <div class="card bg-info">
        <div class="card-body">
            <div class="media align-items-center">
                <div class="text-left media-body">
                    <p class="mb-2 text-white fs-18">دریافتی ها</p>
                    <span class="text-white fs-48 font-w600">75</span>
                </div>
                <span class="p-3 ml-3 rounded feature-icon">
...
<div class="col-xl-3 col-xxl-6 col-sm-6">
    <div class="card bg-success">
        <div class="card-body">
            <div class="media align-items-center">
                <div class="text-left media-body">
                    <p class="mb-2 text-white fs-18">کاربر ها</p>
                    <span class="text-white fs-48 font-w600">45</span>
                </div>
                <span class="p-3 ml-3 rounded feature-icon">
                    <svg width="36" height="36" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="col-xl-3 col-xxl-6 col-sm-6">
    <div class="card bg-secondary">
        <div class="card-body">
            <div class="media align-items-center">
                <div class="text-left media-body">
                    <p class="mb-2 text-white fs-18">پیغام های جدید</p>
                    <span class="text-white fs-48 font-w600">93</span>
                </div>
                <span class="p-3 ml-3 rounded feature-icon">
                    <svg width="36" height="36" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
