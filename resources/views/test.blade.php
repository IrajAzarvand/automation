...
<head>
    ...
    <title>پنل مدیریت | پلاگین SweetAlert</title>
    <meta name="description" content="Some description for the page" />
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png">
    <link href="{{ asset('DashboardElements/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('DashboardElements/vendor/sweetalert2/dist/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('DashboardElements/css/style.css') }}" rel="stylesheet" type="text/css" />
</head>
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <svg class="logo-abbr" width="66.5px" height="66.5px">
                    <g>
                        <path class="svg-logo-circle" fill-rule="evenodd" fill="rgb(64, 24, 157)" d="M32.999,66.000 C14.774,66.000 -0.000,51.225 -0.000,33.000 C-0.000,14.775 14.774,-0.000 32.999,-0.000 C51.225,-0.000 66.000,14.775 66.000,33.000 C66.000,51.225 51.225,66.000 32.999,66.000 Z" />
                    </g>
                    <g>
                        <path class="svg-logo-icon-text" fill-rule="evenodd" stroke="rgb(255, 255, 255)" stroke-width="1px" stroke-linecap="butt" stroke-linejoin="miter" fill="rgb(255, 255, 255)"
        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#notes">یاد داشت ها</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#alerts">هشدار ها</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#chat">پیام</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade active show" id="chat" role="tabpanel">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info">
                                                <span>توماس ادیسون</span>
                                                <p>آخرین بازدید پنجاه سال پیش</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                        ...
                        <div class="card chat dz-chat-history-box d-none">
                            <div class="text-center card-header chat-list-header">
                                ...
                                <div>
                                    <h6 class="mb-1">پیام به انیشتین</h6>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li class="dropdown-item"><i class="mr-2 fa fa-user-circle text-primary"></i> نمایش پروفایل</li>
                                        <li class="dropdown-item"><i class="mr-2 fa fa-users text-primary"></i> اضافه کردن به دوستان شخصی</li>
                                        <li class="dropdown-item"><i class="mr-2 fa fa-plus text-primary"></i> اضافه کردن به گروه</li>
                                        <li class="dropdown-item"><i class="mr-2 fa fa-ban text-primary"></i> بلاک</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="mb-4 d-flex justify-content-start">
                                    ...
                                    <div class="msg_cotainer">
                                        سلام انیشتین چطوری ؟
                                        <span class="msg_time">8:40 بعد از ظهر</span>
                                    </div>
                                </div>
                                <div class="mb-4 d-flex justify-content-end">
                                    <div class="msg_cotainer_send">
                                        به به ، سلام خوبی ؟
                                        <span class="msg_time_send">8:55 بعد از ظهر</span>
                                    </div>
                                    <div class="img_cont_msg">
                                ...
                                <div class="mb-4 d-flex justify-content-start">
                                    ...
                                    <div class="msg_cotainer">
                                        من خوبم خداروشکر ، چخبر چیکار میکنی ؟
                                        <span class="msg_time">9:00 شب</span>
                                    </div>
                                </div>
                                <div class="mb-4 d-flex justify-content-end">
                                    <div class="msg_cotainer_send">
                                        هیچی کاکو درگیر زندگی اون دنیا
                                        <span class="msg_time_send">9:05 شب</span>
                                    </div>
                                    <div class="img_cont_msg">
                                        <img src="images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
                                    </div>
                                ...
                                <div class="mb-4 d-flex justify-content-start">
                                    ...
                                    <div class="msg_cotainer">
                                        اون دنیا چه خبر ؟
                                        <span class="msg_time">9:07 شب</span>
                                    </div>
                                </div>
                                <div class="mb-4 d-flex justify-content-end">
                                    <div class="msg_cotainer_send">
                                        خبری نیست داداش
                                        <span class="msg_time_send">9:10 شب</span>
                                    </div>
                                    <div class="img_cont_msg">
                                        <img src="images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
                                    </div>
                                ...
                                <div class="mb-4 d-flex justify-content-start">
                                    ...
                                    <div class="msg_cotainer">
                                        باش سلام برسون
                                        <span class="msg_time">9:12 شب</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer type_msg">
                                <div class="input-group">
                                    <textarea class="form-control" placeholder="پیام مورد نظر را وارد کنید"></textarea>
                    ...
                    <div class="tab-pane fade" id="alerts" role="tabpanel">
                        <div class="card mb-sm-3 mb-md-0 contacts_card">
                            ...
                            <div class="p-0 card-body contacts_body dz-scroll" id="DZ_W_Contacts_Body1">
                                <ul class="contacts">
                                    <li class="name-first-letter">اخبار سایت</li>
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont primary">ح</div>
                                            <div class="user_info">
                                                <span>تولد حمید موسوی</span>
                                                <p class="text-primary">امروز 10 شهریور</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="name-first-letter">مدیریتی</li>
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont success">ف<i class="icon fa-birthday-cake"></i></div>
                                            <div class="user_info">
                                                <span>تایید درخواست</span>
                                                <p>گزارش مورد نظر شما ثبت شد</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="name-first-letter">عملکرد کاربران</li>
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont primary">د<i class="icon fa fa-user-plus"></i></div>
                                            <div class="user_info">
                                                <span>کاربر جدید</span>
                                                <p>امروز بیش از 10 کاربر جدید ثبت نام کردند</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont info">ت<i class="icon fa fa-user-plus"></i></div>
                                            <div class="user_info">
                                                <span>پرداخت کاربران</span>
                                                <p>6 کاربر پرداخت نهایی انجام دادند</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="card mb-sm-3 mb-md-0 note_card">
                            <div class="text-center card-header chat-list-header">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">اضافه کردن یادداشت جدید</p>
                                </div>
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <div class="p-0 card-body contacts_body dz-scroll" id="DZ_W_Contacts_Body2">
                                <ul class="contacts">
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info">
                                                <span>تبریک تولد محمد</span>
                                                <p>15 شهریور</p>
                                            </div>
                                            <div class="ml-auto">
                                                <a href="#" class="mr-1 rounded btn btn-primary btn-xs sharp"><i class="fa fa-pencil "></i></a>
                                                <a href="#" class="rounded btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info">
                                                <span>افزایش حقوق کارمندان</span>
                                                <p>1 مهر</p>
                                            </div>
                                            <div class="ml-auto">
                                                <a href="#" class="mr-1 rounded btn btn-primary btn-xs sharp"><i class="fa fa-pencil"></i></a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item">
                                <div class="input-group search-area d-xl-inline-flex d-none">
                                    <input type="text" class="form-control" placeholder="یه چیزی جستجو کنید">
                                    <div class="input-group-append">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="#">
                                    ...
                                    <span class="text-white badge light bg-primary rounded-circle">18</span>
                                </a>
                            </li>
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <span class="text-white badge light bg-primary rounded-circle">37</span>
                                </a>
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <small class="d-block">ساعت 14:00</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">درخواست شما موفقیت آمیز بود</h6>
                                                        <small class="d-block">ساعت 17:32</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">تاریخ تسویه رو به اتمام است</h6>
                                                        <small class="d-block">ساعت 21:02</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">دکتر حسینی عکس جدیدی ارسال کرد</h6>
                                                        <small class="d-block">ساعت 18:21</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">درخواست گزارش شما موفقیت آمیز بود</h6>
                                                        <small class="d-block">ساعت 23:26</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">ثبت اطلاعات موفقیت آمیز</h6>
                                                        <small class="d-block">ساعت 23:51</small>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    <a class="all-notification" href="#">نمایش تمام اعلان ها <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <div class="header-info">
                                        <span class="text-black">مهرداد حسینی</span>
                                        <p class="mb-0 fs-12">مدیر ارشد</p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="email-inbox.html" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ml-2">صندوق پیام </span>
                                    </a>
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="index.html">داشبورد روشن</a></li>
                            <li><a href="index2.html">داشبورد تیره</a></li>
                            <li><a href="search-job.html">جستجوی شغل</a></li>
                            <li><a href="application.html">نرم افزار های کاربردی</a></li>
                            <li><a href="profile.html">پروفایل</a></li>
                            <li><a href="job-find.html">پیدا کردن شغل</a></li>
                            <li><a href="companies.html">شرکتی</a></li>
                            <li><a href="statistics.html">آمار و اطلاعاتی</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">بخش ها</span>
                        </a>
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">فروشگاه</a>
                                <ul aria-expanded="false">
                                    <li><a href="ecom-product-grid.html">جدول بندی محصول</a></li>
                                    <li><a href="ecom-product-list.html">لیست محصول</a></li>
                                    <li><a href="ecom-product-detail.html">جزئیات محصول</a></li>
                                    <li><a href="ecom-product-order.html">سفارش ها</a></li>
                                    <li><a href="ecom-checkout.html">تسویه حساب</a></li>
                                    <li><a href="ecom-invoice.html">درآمد</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">نمودار ها</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">نمودارد Flot</a></li>
                            <li><a href="chart-morris.html">نمودار Morris</a></li>
                            <li><a href="chart-chartjs.html">نمودار Chartjs</a></li>
                            <li><a href="chart-chartist.html">نمودار Chartist</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">ابزار های بوت استرپ</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.html">آکوردین (اسلاید کشویی)</a></li>
                            ...
                            <li><a href="ui-media-object.html">محتوا</a></li>
                            <li><a href="ui-card.html">کادر محتوا</a></li>
                            <li><a href="ui-carousel.html">اسلایدر</a></li>
                            <li><a href="ui-dropdown.html">منو کشویی</a></li>
                            <li><a href="ui-popover.html">پیغام شناور ( Popover )</a></li>
                            <li><a href="ui-progressbar.html">پروگرس بار</a></li>
                            <li><a href="ui-tab.html">تب ها</a></li>
                            <li><a href="ui-typography.html">تایپوگرافی</a></li>
                            <li><a href="ui-pagination.html">صفحه بندی</a></li>
                            <li><a href="ui-grid.html">تقسیم بندی</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="uc-select2.html">منوکشویی 2 (Select 2)</a></li>
                            <li><a href="uc-nestable.html">ساختار درختی</a></li>
                            <li><a href="uc-noui-slider.html">انواع اسلاید کنترول</a></li>
                            <li><a href="uc-sweetalert.html">پلاگین هشدار Sweet alert</a></li>
                            <li><a href="uc-toastr.html">پیغام Toastr</a></li>
                            <li><a href="map-jqvmap.html">نقشه</a></li>
                            <li><a href="uc-lightgallery.html">گالری تصاویر</a></li>
                        </ul>
                    </li>
                    <li><a href="widget-basic.html" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-settings-2"></i>
                            <span class="nav-text">ابزارک های جالب</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="form-element.html">ابزار های فرم</a></li>
                            <li><a href="form-wizard.html">فرم مرحله ای یا جادویی</a></li>
                            <!--                            <li><a href="form-editor-summernote.html">کادر ویرایش متنی</a></li>-->
                            <li><a href="form-pickers.html">انتخاب تاریخ ، رنگ و زمان</a></li>
                            <li><a href="form-validation-jquery.html">جی کوئری ولیدیت (JQuery Validate)</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.html">بوت استرپ</a></li>
                            <li><a href="table-datatable-basic.html">دیتاتیبل(جدول داده)</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">صفحه ها</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="page-register.html">ثبت نام</a></li>
                            <li><a href="page-login.html">ورود</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">ارور</a>
                                <ul aria-expanded="false">
                            ...
                            <li><a href="page-lock-screen.html">قفل کردن صفحه</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="copyright">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">پیغام خطا</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-danger sweet-wrong">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیام معمولی با تایید</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-info sweet-message">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">پیغام موفقیت آمیز</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-success sweet-success">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">پیغام تایید</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-warning sweet-confirm">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">پیغام تایید یا عدم تایید</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-warning sweet-success-cancel">کلیک کنید
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیغام</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-info sweet-image-message">کلیک کنید
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیغام با محتوا</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-primary sweet-html">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیغام شمارش معکوس</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-danger sweet-auto">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیغام و بستن با کلید</h4>
                                <div class="card-content">
                                    <div class="mt-5 sweetalert">
                                        <button class="btn btn-success sweet-prompt">کلیک کنید</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xxl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">نمایش پیغام ajax</h4>
                                <div class="card-content"></div>
                                <div class="mt-4 sweetalert">
                                    <button class="btn btn-info sweet-ajax">کلیک کنید</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
***********************************-->
    ...
    <script src="{{ asset('DashboardElements/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}" type="text/javascript"></script>
