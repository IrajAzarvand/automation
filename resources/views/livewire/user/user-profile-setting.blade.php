                    ...
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <div class="button-wrapper">
                            <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                ...
                                <input wire:model="profilePhoto" type="file" id="upload" class="account-file-input"
                                    hidden accept=".jpg">
                            </label>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input wire:model.defer="mobile" type="number" name="phoneNumber"
                                        class="form-control text-start" dir="ltr" placeholder="شماره تماس را وارد کنید">
                                </div>
                                @error('mobile')
                                <span style="color: red" class="error">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input wire:model.defer="telegram" type="number" name="telegramNumber"
                                        class="form-control text-start" dir="ltr" placeholder="شماره تلفن اکانت تلگرام">
                                </div>
                                @error('telegram')
                                <span style="color: red" class="error">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input wire:model.defer="whatsapp" type="number" name="whatsappNumber"
                                        class="form-control text-start" dir="ltr" placeholder="شماره تلفن اکانت واتساپ">
                                </div>
                                @error('whatsapp')
                                <span style="color: red" class="error">{{ $message }}</span>
                                @enderror
