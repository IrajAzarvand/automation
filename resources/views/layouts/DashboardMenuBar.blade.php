        ...
        <ul class="menu-inner">
                                ...
                                <ul class="menu-sub">
                                    ...
                                    <li class="menu-item">
                                        <a href="app-user-view-billing.html" class="menu-link">
                                            <div data-i18n="Billing & Plans">صورتحساب و پلن‌ها
                                            </div>
                                        </a>
                                    </li>
                                    <li class="menu-item">
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                    ...
                    <div data-i18n="Components">اجزاء</div>
                </a>
                <ul class="menu-sub">
                    <!-- Cards -->
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="ui-dropdowns.html" class="menu-link">
                                    <div data-i18n="Dropdowns">منوی کشویی</div>
                                </a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="ui-pagination-breadcrumbs.html" class="menu-link">
                                    <div data-i18n="Pagination & Breadcrumbs">صفحه‌بندی و مسیرهای
                                        راهنما</div>
                                </a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="ui-tooltips-popovers.html" class="menu-link">
                                    <div data-i18n="Tooltips & popovers">تولتیپ‌ها و پاپ‌اورها
                                    </div>
                                </a>
                            </li>
                            <li class="menu-item">
