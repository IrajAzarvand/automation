                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card d-flex flex-xl-column flex-sm-column flex-md-row flex-column">
                                    <div class="text-center card-body profile-bx">
                                        <div class="mb-4 profile-image">
                                            <img src="{{ asset('DashboardElements/images/avatar/1.jpg') }}" class="rounded-circle" alt="">
                                        </div>
                                        <h4 class="mb-1 text-black fs-22">مهرداد</h4>
                                        <p class="mb-4">برنامه نویس ، طراح</p>
                                        <div class="row">
                                            <div class="p-0 col-4">
                                    ...
                                    <div class="card-body col-xl-12 col-md-6 col-sm-12 activity-card">
                                        <h4 class="mb-3 text-black fs-18">آخرین فعالیت ها</h4>
                                        <div class="mb-4 media">
                                            <span class="p-3 mr-3 border rounded">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-1 text-black fs-14 font-w500">شما<strong> 10 دقیقه قبل </strong> وارد پنل شدید </p>
                                                <span class="fs-14">17:23</span>
                                            </div>
                                        </div>
                                        <div class="mb-4 media">
                                            <span class="p-3 mr-3 border rounded">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-1 text-black fs-14 font-w500">شما<strong> 40 دقیقه قبل </strong>از پنل خارج شدید </p>
                                                <span class="fs-14">17:44</span>
                                            </div>
                                        </div>
                                        <div class="mb-4 media">
                                            <span class="p-3 mr-3 border rounded">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-1 text-black fs-14 font-w500">شما<strong> 20 دقیقه قبل </strong> وارد پنل شدید </p>
                                                <span class="fs-14">17:44</span>
                                            </div>
                                        </div>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-1 text-black fs-14 font-w500">
                                                    بیشترین میزان پیام دریافتی شما در تاریخ <strong> 10 شهریور </strong>می باشد </p>
                                                <span class="fs-14">19:42</span>
                                            </div>
                                        </div>
                                        <div class="mb-4 media">
                                            <span class="p-3 mr-3 border rounded">
