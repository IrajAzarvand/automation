    ...
    return function () {
        ...
        return function () {
            ...
            var s = {
                ...
                renameFile: null,
                forceFallback: !1,
                dictDefaultMessage: "فایل های خود را در این محل بکشید و رها کنید",
                dictFallbackMessage: "مرورگر شما از قابلیت کشیدن و رها کردن فایل پشتیبانی نمی کند.",
                dictFallbackText: "لطفا از قسمت پایین برای آپلود فایل های خود استفاده کنید.",
                dictFileTooBig: "اندازه فایل ({{filesize}}MB) می باشد. حداکثر اندازه قابل قبول: {{maxFilesize}}KB.",
                dictInvalidFileType: "امکان آپلود این پسوند فایل وجود ندارد.",
                dictResponseError: "خطای سرور با کد {{statusCode}}.",
                dictCancelUpload: "لغو آپلود",
                dictUploadCanceled: "آپلود لغو شد.",
                dictCancelUploadConfirmation: "آیا از لغو فرایند آپلود مطمئن هستید؟",
                dictRemoveFile: "حذف فایل",
                dictRemoveFileConfirmation: null,
                dictMaxFilesExceeded: "امکان آپلود بیشتر از این تعداد وجود ندارد.",
